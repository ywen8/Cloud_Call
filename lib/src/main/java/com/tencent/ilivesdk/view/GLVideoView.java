...
public class GLVideoView extends GLView {
    ...
    protected boolean isFristFrame = false;
    ...
    protected boolean hasBlackBorder(int rotation, boolean isDegreeFixed) {
